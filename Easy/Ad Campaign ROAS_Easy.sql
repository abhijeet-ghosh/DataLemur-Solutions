...
DataLemur Question Link : https://datalemur.com/questions/ad-campaign-roas

Solution: 

SELECT advertiser_id, ROUND(SUM(revenue)::decimal / SUM(spend),2) AS ROAS FROM ad_campaigns
