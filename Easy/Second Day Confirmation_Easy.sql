...
DataLemur Question Link : https://datalemur.com/questions/second-day-confirmation
...
AND t.action_date = e.signup_date::date + '1 day'::interval
)

SELECT user_id FROM Confirm;