...
DataLemur Question Link: https://datalemur.com/questions/top-profitable-drugs

Solution:

SELECT drug, total_profit 
FROM (SELECT drug, total_sales-cogs AS total_profit FROM pharmacy_sales) profitcalc
